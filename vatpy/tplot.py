...
class TerminalPlot:
    ...
    def __init__(self, file, savepath=os.getcwd(), vmin=None, vmax=None, xlim=None, ylim=None, 
                 style=None, saveformat=None, interactive=False, imgcatwidth=None):
        # Variables:
        self.file        = file
    ...
    def density(self, axis='z', rotate=0, quantity='mass', bins=100, xrange=None, yrange=None, zrange=None, cut=None):
        '''
    ...
    def temperature(self, axis='z', rotate=0, bins=100, xrange=None, yrange=None, zrange=None, cut=None):
        '''
        Description: Gas density plot. 
        '''
        # Read the data:
